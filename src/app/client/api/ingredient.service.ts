...
export class IngredientService {
     ...
     */
    public findIngredientById(id: number, extraHttpRequestParams?: any): Observable<Ingredient> {
        return this.findIngredientByIdWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param id ID of the ingredient to get
     */
    public findIngredientByIdWithHttpInfo(id: number, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + '/ingredient/${id}'
                    .replace('${' + 'id' + '}', String(id));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling findIngredientById.');
        }
